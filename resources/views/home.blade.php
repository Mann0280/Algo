...
@section('content')
    ...
    <section class="py-20 sm:py-32 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 relative z-10">
            <!-- Header -->
            <div class="text-center mb-16">
                <span class="orbitron text-[10px] font-black text-purple-400 tracking-[0.3em] uppercase mb-4 block">Premium Access</span>
                <h2 class="orbitron text-3xl md:text-5xl font-black mb-5 uppercase italic tracking-tighter text-white">Choose Your <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">Plan</span></h2>
                <p class="text-gray-400 max-w-xl mx-auto text-sm leading-relaxed">Get full access to AI-powered stock signals, real-time alerts, and premium predictions.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 max-w-6xl mx-auto">
                ...
                <div class="relative group">
                    <div class="h-full rounded-3xl border border-white/10 p-8 flex flex-col transition-all duration-300 hover:-translate-y-2 hover:border-purple-500/30 hover:shadow-[0_0_40px_rgba(147,51,234,0.12)]" style="background: rgba(255,255,255,0.03); backdrop-filter: blur(10px);">
                        ...
                        <button onclick="@auth buyPlan(200) @else window.location.href='{{ route('login') }}' @endauth" class="block w-full py-3.5 rounded-2xl text-center text-sm font-bold text-white border border-white/10 hover:border-purple-500/40 hover:bg-purple-500/10 transition-all">
                            Get Started
                        </button>
                    </div>
                </div>
                ...
                <div class="relative group">
                    <div class="h-full rounded-3xl border border-white/10 p-8 flex flex-col transition-all duration-300 hover:-translate-y-2 hover:border-purple-500/30 hover:shadow-[0_0_40px_rgba(147,51,234,0.12)]" style="background: rgba(255,255,255,0.03); backdrop-filter: blur(10px);">
                        ...
                        <button onclick="@auth buyPlan(2800) @else window.location.href='{{ route('login') }}' @endauth" class="block w-full py-3.5 rounded-2xl text-center text-sm font-bold text-white border border-white/10 hover:border-purple-500/40 hover:bg-purple-500/10 transition-all">
                            Get Started
                        </button>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div class="relative h-full rounded-3xl p-8 flex flex-col" style="background: linear-gradient(145deg, rgba(124,58,237,0.15), rgba(99,102,241,0.08)), rgba(10,5,20,0.9); backdrop-filter: blur(10px);">
                        <div class="mb-6 mt-2">
                        ...
                        <button onclick="@auth buyPlan(3000) @else window.location.href='{{ route('login') }}' @endauth" class="block w-full py-3.5 rounded-2xl text-center text-sm font-bold text-white transition-all hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(124,58,237,0.4)]" style="background: linear-gradient(135deg, #7c3aed, #6366f1);">
                            Get Started
                        </button>
                    </div>
                </div>
                ...
                <div class="relative group">
                    <div class="h-full rounded-3xl border border-amber-500/20 p-8 flex flex-col transition-all duration-300 hover:-translate-y-2 hover:border-amber-500/40 hover:shadow-[0_0_40px_rgba(245,158,11,0.08)]" style="background: rgba(255,255,255,0.03); backdrop-filter: blur(10px);">
                        ...
                        <button onclick="@auth buyPlan(30000) @else window.location.href='{{ route('login') }}' @endauth" class="block w-full py-3.5 rounded-2xl text-center text-sm font-bold text-white border border-amber-500/30 hover:bg-amber-500/10 hover:border-amber-500/50 transition-all">
                            Get Started
                        </button>
                    </div>
                </div>
...
@auth
<!-- Wallet Top-up Modal -->
<div id="funds-modal-container" class="fixed inset-0 hidden">
    <div class="absolute inset-0 bg-[#030008]/80 backdrop-blur-md" onclick="closeFundsModal()"></div>
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg p-6">
        <div class="glass-panel border-white/10 rounded-[3rem] overflow-hidden relative shadow-2xl">
            <!-- Modal Header -->
            <div class="relative px-8 pt-10 pb-6 text-center">
                <button onclick="closeFundsModal()" class="absolute top-8 right-8 text-gray-500 hover:text-white transition-colors">
                    <i data-lucide="x" class="w-6 h-6"></i>
                </button>
                <h2 class="text-2xl font-black orbitron italic uppercase tracking-tighter text-white">
                    Purchase <span class="text-amber-500">Plan</span>
                </h2>
                <p class="text-gray-400 text-xs font-semibold uppercase tracking-widest mt-2">Secure Payment Gateway</p>
            </div>

            <!-- Steps Progress -->
            <div class="flex items-center justify-center gap-3 mb-10">
                <div id="step-ind-1" class="step-indicator w-7 h-7 rounded-full flex items-center justify-center text-[8px] font-black orbitron active">1</div>
                ...
                <form id="funds-form" action="{{ route('account.wallet.topup.submit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="fund-step-1" class="space-y-6">
                        <div class="text-center space-y-2">
                            ...
                            <h3 class="text-lg font-bold text-white tracking-tight">Confirm Amount</h3>
                            <p class="text-sm text-gray-500 text-center">Plan Price: <span id="display-plan-amount" class="text-white font-bold">&#8377;0</span></p>
                        </div>
                        <input type="hidden" name="amount" id="fund-amount" value="0">
                        <button type="button" onclick="goToStep(2)" class="w-full py-5 mt-4 bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-2xl font-bold uppercase tracking-[0.1em] text-sm transition-all hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(245,158,11,0.3)] active:scale-[0.98] flex items-center justify-center gap-3">
                    ...
                    <div id="fund-step-2" class="hidden space-y-6">
                        <div class="text-center space-y-2">
                            <h3 class="text-lg font-bold text-white tracking-tight">Scan & Pay</h3>
                            <p class="text-sm text-gray-500">Scan QR or use UPI ID to complete payment</p>
                        </div>
                        ...
                        <div class="flex flex-col items-center gap-5">
                            <div class="relative w-44 h-44 p-3 bg-white/[0.03] rounded-[1.75rem] border border-amber-500/20 overflow-hidden">
                                ...
                                <div class="bg-white rounded-2xl p-2 h-full flex items-center justify-center">
                                    <div id="dynamic-qrcode"></div>
                                </div>
                            </div>
                            @if(!empty($walletSettings['upi_id']))
                            <div class="w-full p-4 rounded-xl bg-white/[0.02] border border-white/[0.06] flex items-center justify-between">
                                ...
                                <button type="button" onclick="copyUPIWallet()" class="w-9 h-9 rounded-lg bg-amber-500/10 text-amber-500 flex items-center justify-center hover:bg-amber-500 hover:text-black transition-all">
                                    <i data-lucide="copy" class="w-3.5 h-3.5" id="copy-icon-modal"></i>
                                </button>
                            </div>
                            @endif
                        </div>
                        <div class="flex gap-3 mt-6">
                            <button type="button" onclick="goToStep(1)" class="flex-1 py-4 rounded-xl border border-white/10 text-gray-400 font-semibold text-sm hover:bg-white/5 transition-all">Back</button>
                            <button type="button" onclick="goToStep(3)" class="flex-[2] py-4 bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-xl font-bold text-sm transition-all hover:shadow-lg">I Have Paid</button>
                        </div>
                    </div>
                    ...
                    <div id="fund-step-3" class="hidden space-y-6">
                        <div class="text-center space-y-2">
                            <h3 class="text-lg font-bold text-white tracking-tight">Verify Payment</h3>
                            <p class="text-sm text-gray-500">Enter the UTR number from your payment app</p>
                        </div>
                        <div class="space-y-3">
                            <label class="text-xs font-semibold text-gray-400 uppercase tracking-widest pl-1">UTR / Transaction ID</label>
                            <input type="text" id="verify_utr_input" class="w-full bg-white/[0.02] border border-white/[0.08] rounded-xl px-6 py-4 text-white text-sm font-semibold outline-none focus:border-emerald-500/40" placeholder="Enter 12-digit UTR number">
                            <p id="utr-error" class="hidden text-xs font-semibold text-rose-500 text-center"></p>
                        </div>
                        <div class="flex gap-3">
                            <button type="button" onclick="goToStep(2)" class="flex-1 py-4 rounded-xl border border-white/10 text-gray-400 font-semibold text-sm hover:bg-white/5 transition-all">Back</button>
                            <button type="button" id="verify-utr-btn" onclick="verifyUtr()" class="flex-[2] py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-xl font-bold text-sm transition-all">Verify UTR</button>
                        </div>
                    </div>
                    ...
                    <div id="fund-step-4" class="hidden space-y-6">
                        <div class="text-center space-y-2">
                            <h3 class="text-lg font-bold text-white tracking-tight">Upload Proof</h3>
                            <p class="text-sm text-gray-500">Upload screenshot for final verification</p>
                        </div>
                        <div class="space-y-4">
                            <select name="payment_method" class="w-full bg-[#0a0514] border border-white/10 rounded-xl px-5 py-4 text-white text-sm">
                                <option value="UPI">UPI / G-Pay / PhonePe</option>
                                <option value="Bank Transfer">Bank Transfer</option>
                                <option value="QR Scan">QR Code Scan</option>
                            </select>
                            <label class="w-full border border-dashed border-white/10 rounded-xl p-5 flex items-center gap-4 cursor-pointer hover:bg-white/5 transition-colors">
                                <i data-lucide="image-plus" class="w-6 h-6 text-purple-400"></i>
                                <span id="fund-file-name" class="text-sm text-gray-500 truncate">Choose screenshot...</span>
                                <input type="file" name="screenshot" accept="image/*" class="hidden" onchange="handleFileSelect(this)">
                            </label>
                        </div>
                        <div class="flex gap-3">
                            <button type="button" onclick="goToStep(3)" class="flex-1 py-4 rounded-xl border border-white/10 text-gray-400 font-semibold text-sm hover:bg-white/5 transition-all">Back</button>
                            <button type="submit" class="flex-[2] py-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-bold text-sm transition-all hover:shadow-lg">Submit Review</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function buyPlan(amount) {
        ...
        document.getElementById('display-plan-amount').innerText = '₹' + amount.toLocaleString('en-IN');
        document.getElementById('funds-modal-container').classList.remove('hidden');
    ...
    function closeFundsModal() {
        document.getElementById('funds-modal-container').classList.add('hidden');
                ...
                if (data.success) {
                    ...
                    if (upiId) {
                        ...
                        new QRCode(qrContainer, {
                            ...
                            colorDark : "#030303", colorLight : "#ffffff",
                            correctLevel : QRCode.CorrectLevel.H
                        });
                    }
                    document.getElementById('step2-amount').innerText = '₹' + amount.toLocaleString('en-IN');
                } else {
        ...
        for (let i = 1; i <= TOTAL_STEPS; i++) {
            ...
            if(ind) {
                ...
                if (i < step) {
                    ...
                    ind.innerHTML = '<i data-lucide="check" class="w-3.5 h-3.5"></i>';
                } else if (i === step) {
    ...
    async function verifyUtr() {
        const utrVal = document.getElementById('verify_utr_input').value.trim();
        ...
        try {
            ...
            if (data.success) {
                ...
                errorText.innerText = data.message || "Failed";
                errorText.classList.remove('hidden');
            }
        } catch (err) { console.error(err); }
        verifyBtn.disabled = false;
        verifyBtn.innerText = 'Verify UTR';
        lucide.createIcons();
    }
    ...
    function copyUPIWallet() {
        ...
        navigator.clipboard.writeText(upiId).then(() => {
            const icon = document.getElementById('copy-icon-modal');
