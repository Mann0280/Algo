                    ...
                    <tr class="group hover:bg-white/[0.01] transition-all duration-500">
                        ...
                        <td class="px-10 py-8">
                            <div class="flex items-center gap-3">
                                ...
                                <button onclick="viewProof('{{ str_starts_with($item->display_proof, 'uploads/') ? asset($item->display_proof) : (str_starts_with($item->display_proof, 'http') ? $item->display_proof : Storage::disk('public')->url($item->display_proof)) }}')" class="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-center justify-center hover:bg-emerald-500/20 transition-all group/btn">
