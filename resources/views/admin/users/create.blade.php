...
<div class="max-w-2xl mx-auto space-y-8">
    ...
    <div class="glass-card rounded-[2.5rem] border border-white/5 overflow-hidden">
        <form action="{{ route('admin.users.store') }}" method="POST" class="p-10 space-y-8">
            ...
            <div class="space-y-6">
                <div>
                    <label class="block text-[10px] font-bold font-whiskey text-gray-500 uppercase tracking-widest mb-3 px-1">Protocol Identifier (Username)</label>
                ...
                <div>
                    <label class="block text-[10px] font-bold font-whiskey text-gray-500 uppercase tracking-widest mb-3 px-1">Access Tier (Role)</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-[10px] font-bold font-whiskey text-gray-500 uppercase tracking-widest mb-3 px-1">Security Key</label>
                    ...
                    <div>
                        <label class="block text-[10px] font-bold font-whiskey text-gray-500 uppercase tracking-widest mb-3 px-1">Confirm Key</label>
            ...
            <button type="submit" class="w-full py-5 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl text-white font-black font-whiskey uppercase tracking-widest text-xs hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-purple-500/20 italic">
