...
<div id="video-feed-section" class="hidden mt-12 animate-in fade-in slide-in-from-top-4 duration-1000">
    <div class="flex items-center justify-between mb-6 px-1">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-[10px] font-black orbitron text-white uppercase tracking-[0.3em]">Neural Video Analysis</h2>
        </div>
        <div id="video-count" class="text-[9px] font-bold orbitron text-gray-600 uppercase tracking-widest">0 active streams</div>
    </div>
