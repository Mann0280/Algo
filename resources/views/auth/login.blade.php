...
<div class="w-full max-w-[420px] animate-in fade-in slide-in-from-bottom-6 duration-700">
    <div class="glass-card rounded-[2.5rem] p-8 sm:p-10 relative overflow-hidden group">
        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-5 relative z-10">
            ...
            <button type="submit" id="loginSubmitBtn" class="auth-btn w-full py-4 rounded-xl text-white font-black orbitron text-[10px] tracking-[0.2em] uppercase italic flex items-center justify-center gap-2.5 mt-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed">
