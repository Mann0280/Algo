    ...
    <div class="container mx-auto max-w-6xl relative z-10">
        ...
        <div class="glass-panel p-8 rounded-[2.5rem] border border-white/5 mb-12 fade-in-up" style="animation-delay: 0.1s">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="flex items-center gap-5">
                    ...
                    <div class="text-left">
                        <div class="text-[10px] font-black font-whiskey text-gray-500 uppercase tracking-widest mb-1">Daily Usage Quota</div>
                        <div class="text-lg font-bold text-white uppercase italic">1 of 3 Used <span class="text-purple-500 text-sm ml-2 font-whiskey font-normal tracking-normal">- 2 Remaining</span></div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 fade-in-up" style="animation-delay: 0.15s">
            <div class="glass-panel p-6 rounded-2xl border border-white/5 relative overflow-hidden group shadow-lg">
                ...
                <div class="text-[9px] font-black font-whiskey text-slate-500 uppercase tracking-widest mb-3">Active Nodes</div>
                <div class="flex items-center gap-3">
                    <span class="text-2xl font-black text-white font-whiskey tracking-tighter">12/12</span>
            ...
            <div class="glass-panel p-6 rounded-2xl border border-white/5 relative overflow-hidden group shadow-lg">
                ...
                <div class="text-[9px] font-black font-whiskey text-slate-500 uppercase tracking-widest mb-3">Throughput</div>
                <div class="text-2xl font-black text-white font-whiskey tracking-tighter">4.2<span class="text-xs text-slate-500 ml-1">GB/S</span></div>
            </div>
            <div class="glass-panel p-6 rounded-2xl border border-white/5 relative overflow-hidden group shadow-lg">
                <div class="absolute top-0 right-0 w-24 h-24 bg-emerald-600/5 blur-2xl -z-10"></div>
                <div class="text-[9px] font-black font-whiskey text-slate-500 uppercase tracking-widest mb-3">Neural Sync</div>
            ...
            <div class="glass-panel p-6 rounded-2xl border border-white/5 relative overflow-hidden group shadow-lg">
                ...
                <div class="text-[9px] font-black font-whiskey text-slate-500 uppercase tracking-widest mb-3">Latency</div>
                <div class="text-2xl font-black text-white font-whiskey tracking-tighter">14<span class="text-xs text-slate-500 ml-1">MS</span></div>
            </div>
        </div>
            ...
            <div class="flex flex-col lg:flex-row divide-y lg:divide-y-0 lg:divide-x divide-white/5">
                <div class="lg:pr-12 pb-8 lg:pb-0 flex-1">
                    <div class="flex items-center justify-between mb-6">
                        <span class="text-[10px] font-black font-whiskey text-slate-500 uppercase tracking-[0.2em]">Market Sentiment</span>
                        <span class="text-[10px] font-black font-whiskey text-emerald-400 uppercase tracking-widest">Bullish</span>
                    </div>
                    <div class="flex items-center gap-6">
                        <div class="relative w-20 h-20 flex items-center justify-center">
                            ...
                            <span class="absolute text-xl font-black font-whiskey">68%</span>
                        </div>
                        <div class="flex-grow space-y-3">
                            <div class="flex justify-between text-[9px] font-bold font-whiskey uppercase text-slate-400">
                ...
                <div class="lg:px-12 py-8 lg:py-0 flex-1">
                    <div class="flex items-center justify-between mb-6">
                        <span class="text-[10px] font-black font-whiskey text-slate-500 uppercase tracking-[0.2em]">Neural Momentum</span>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="p-4 bg-white/[0.03] rounded-2xl border border-white/5 hover:bg-white/[0.05] transition-all">
                            <div class="text-[8px] font-bold text-slate-500 font-whiskey uppercase mb-1">Volatility</div>
                            <div class="flex items-center gap-2">
                                <i data-lucide="activity" class="w-3 h-3 text-purple-400"></i>
                                <span class="text-xs font-black font-whiskey uppercase text-white">Medium</span>
                            </div>
                        </div>
                        <div class="p-4 bg-white/[0.03] rounded-2xl border border-white/5 hover:bg-white/[0.05] transition-all">
                            <div class="text-[8px] font-bold text-slate-500 font-whiskey uppercase mb-1">Volume Proxy</div>
                            <div class="flex items-center gap-2">
                                <i data-lucide="bar-chart-3" class="w-3 h-3 text-blue-400"></i>
                                <span class="text-xs font-black font-whiskey uppercase text-white">Extreme</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="relative w-full overflow-hidden py-10 mb-20 fade-in-up" style="animation-delay: 0.25s">
            <div class="flex items-center gap-4 mb-8 px-4 justify-center md:justify-start">
                ...
                <span class="text-[10px] font-black font-whiskey text-white uppercase tracking-[0.4em] opacity-60">Neural Achievement Stream</span>
            </div>
            <div class="flex gap-6 animate-ticker-slow">
                ...
                <div class="flex-shrink-0 flex items-center gap-6 px-8 py-6 glass-panel rounded-3xl border border-white/5 border-l-4 border-l-{{ $s['color'] }}-500 min-w-[280px] group/item hover:bg-white/10 transition-all">
                    <div class="flex flex-col">
                        <span class="text-base font-black font-whiskey text-white tracking-tighter">{{ $s['pair'] }}</span>
                        <span class="text-[9px] font-bold text-slate-500 font-whiskey uppercase tracking-widest mt-1">{{ $s['msg'] }}</span>
                    </div>
                    <div class="ml-auto text-{{ $s['color'] }}-400 font-black font-whiskey text-xl tracking-tighter">
                        {{ $s['pnl'] }}
                    </div>
                </div>
                @endforeach
        ...
        <div class="glass-panel p-6 md:p-10 rounded-3xl border-white/20 border-l-4 border-l-white relative overflow-hidden mb-20 fade-in-up group hover:bg-white/5 transition-all duration-500" style="animation-delay: 0.3s">
            <div class="absolute top-0 right-0 w-64 h-64 bg-white/5 blur-[80px] -z-10 group-hover:bg-white/10 transition-all duration-700"></div>
            
            <div class="flex flex-col lg:flex-row items-center justify-between gap-8 relative z-10">
                <div class="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
                    <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-white/80 to-white flex items-center justify-center shadow-[0_10px_30px_rgba(255,255,255,0.2)] animate-pulse">
                        <i data-lucide="crown" class="w-10 h-10 text-black fill-black/20"></i>
                    </div>
                    <div>
